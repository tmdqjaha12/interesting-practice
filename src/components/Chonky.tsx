...
import { useStoryLinks } from "@utils/vfs";
    ...
    <div className="story-wrapper">
      <div className="story-description">
        ...
        <p>
          ...
          delete files, move files around using drag & drop, or even create new
          folders.
        </p>
        <p>
          You can see the source code of relevant components by clicking on the
          buttons below. Note that <code>VFSBrowser</code> component&quot;s
